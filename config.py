...
# Allow the host app to point at a custom config file path
...
def cfg(key: str, default: Any = None) -> Any:
    ...
    Lookup order:
      1. config.json  (keys match env var names exactly, e.g. "AZURE_OPENAI_API_KEY")
      2. os.environ   (includes values loaded from .env by dotenv)
      3. default      (the value passed as the second argument)
    """
...
def reload(config_file: str | Path = None) -> None:
    ...
    Useful when the host app sets CONFIG_FILE after import.
    """
